...
//        });
    ...
    public AppBuilder addChatUseCase() {
        ...
        vacationBotInteractor = new VacationBotInteractor(vacationBotPresenter, firestoreUserDataAccessObject,firestoreGroupDataAccessObject, messageFactory, responseFactory);
